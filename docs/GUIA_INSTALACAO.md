...
14. **SQL Editor → New query**: cole o conteúdo de `supabase/seed/seed.sql` e rode.
15. Copie o UUID da eleição mostrado na mensagem final: este é seu `VITE_ELECTION_ID`.
16. **Settings → API** copie:
