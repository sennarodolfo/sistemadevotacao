...
15. **SQL Editor → New query**: cole o conteúdo de `supabase/seed/seed.sql` e rode.
16. Copie o UUID da eleição mostrado na mensagem final: este é seu `VITE_ELECTION_ID`.
17. **Settings → API** copie:
